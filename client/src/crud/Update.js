...
const Update = () => {
    ...
    const { data: blogs } = useFetch('https://react-blog-dtimlb9j1-sam-takahashi.vercel.app/blogs');


    // fetch single (blog) endpoint
    useEffect(() => {
        fetch('https://react-blog-dtimlb9j1-sam-takahashi.vercel.app/blog/' + theId)
            .then(res => {
                return res.json()
    ...
    const handleSubmit = (e) => {
        ...
        fetch('https://react-blog-dtimlb9j1-sam-takahashi.vercel.app/update-blog/' + theId, {
            method: 'PUT',
